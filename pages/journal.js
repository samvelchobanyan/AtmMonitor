...
class JournalPage extends DynamicElement {
    ...
    addEventListeners() {
        ...
        this.addEventListener("export-clicked", (e) => {
            e.detail.url = `/journal/export?${this.tableLink}`;
        });
    }
    ...
    buildTable() {
        ...
        table.setAttribute("data-source", this.tableLink);
    }
          ...
          <div class="container">
            ...
            <div class="table-container">
                <simple-grid
                    ...
                    columns='["atm_id","date","server_date","transaction_id","code","card_number","event_description"]'
                    column-labels='{"atm_id":"Բանկոմատի ID","date":"Ամսաթիվ","server_date":"Սերվերի ամսաթիվ","transaction_id":"Գործարքի ID","code":"Կոդ","card_number":"Քարտի համար","event_description":"Միջոցառման նկարագրություն"}'
                    mode="server"
                    per-page="10"
                    exportable>
                </simple-grid>

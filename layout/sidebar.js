        ...
        <aside class="sidebar">
            ...
            <div class="sidebar__nav">
                <a href="" class="sidebar__item active">
                    <i class="icon icon-grid"></i><span>Ակնարկ</span>
                </a>
                ...
                <a href="" class="sidebar__item">
                    <i class="icon icon-box"></i><span>Բանկոմատներ</span>
                </a>
                <a href="" class="sidebar__item">
                    <i class="icon icon-x-octagon"></i><span>Անսարքություններ</span>
                </a>
                <a href="" class="sidebar__item">
                    <i class="icon icon-clipboard"></i><span>Մատյան</span>
                </a>
            </div>
        </aside>
    `;

// old version, just for upload to demo
...
//             const tableContainer = this.$(".top_table");
//             if (tableContainer) {
//                 tableContainer.innerHTML = this.renderTopTable(response.data.top_faulting_atms);
//             }
//         } catch (err) {
//             console.error("❌ Error fetching summary:", err);
//             this.setState({ summary: null });
...
//     async fetchChartSummary(queryString) {
//         // const queryString = this.buildBottomQueryString();
...
//             // if (this.filtrationTabs !== null) this.submitListener();
...
//             const tableContainer = this.$(".bottom_table");
//             if (tableContainer) {
//                 tableContainer.innerHTML = this.renderBottomTable(tableResponse.data);
//             }
...
//         console.log("render this.deviceTypes", this.deviceTypes);
